...
#############################################################################################################################################
SERVERS = [922,4934]  #set to [] if you just want to test the closest 5 servers, or set to list of server IDs to test (http://www.speedtest.net/speedtest-servers.php)
ISP_DL = 200 #ISP advertised download speed in Mbits/s
ISP_UL = 20 #ISP advertised upload speed in Mbits/s
